...
template <class T> class array_2d : public vector<T>, public multiarray<T> {
  public:
    array_2d() : vector<T>(), dim1_d(0), dim2_d(0) {}
    array_2d(const int d1, const int d2)
        : vector<T>(d1 * d2), dim1_d(d1), dim2_d(d2) {}
    void Clear() {
...
template <class T> class array_3d : public vector<T>, public multiarray<T> {
  public:
    array_3d()
        : dim1_d(0), dim2_d(0), dim3_d(0), dim2_times_dim3_d(0), vector<T>() {}
    array_3d(const int d1, const int d2, const int d3)
        : dim1_d(d1), dim2_d(d2), dim3_d(d3),
          dim2_times_dim3_d(d2 * d3), vector<T>(d1 * d2 * d3) {}
    ...
    void resize(const int i, const int j, const int k) {
        vector<T>::resize(i * j * k);
        dim1_d = i;
        dim2_d = j;
        dim3_d = k;
        dim2_times_dim3_d = dim2_d * dim3_d;
    }
    int dim1() const { return dim1_d; }
    int dim2() const { return dim2_d; }
...
template <class T> class array_4d : public vector<T>, public multiarray<T> {
  public:
    array_4d()
        : dim1_d(0), dim2_d(0), dim3_d(0), dim4_d(0), dim3_times_dim4_d(0),
          dim2_times_dim3_times_dim4_d(0), vector<T>() {}
    array_4d(const int d1, const int d2, const int d3, const int d4)
        : dim1_d(d1), dim2_d(d2), dim3_d(d3), dim4_d(d4),
          dim3_times_dim4_d(d3 * d4),
          dim2_times_dim3_times_dim4_d(d2 * d3 * d4), vector<T>(d1 * d2 * d3 *
                                                                d4) {}
    T &operator()(const int i, const int j, const int k, const int l) {
        ...
        assert((0 <= k) && (k < dim3_d));
        assert((0 <= l) && (l < dim4_d));
        return vector<T>::operator[](i *dim2_times_dim3_times_dim4_d +
                                     j * dim3_times_dim4_d + k * dim4_d + l);
    }
    ...
    array_4d<T> &operator+=(const array_4d<T> &C) {
        assert(dim1() == C.dim1() && dim2() == C.dim2() && dim3() == C.dim3() &&
               dim4() == C.dim4());
    ...
    void resize(const int i, const int j, const int k, const int l) {
        vector<T>::resize(i * j * k * l);
        dim1_d = i;
        dim2_d = j;
        dim3_d = k;
        dim4_d = l;
        dim2_times_dim3_times_dim4_d = dim2_d * dim3_d * dim4_d;
        dim3_times_dim4_d = dim3_d * dim4_d;
    }
  ...
  private:
    ...
    template <class Archive>
    void serialize(Archive &ar, const unsigned int version) {
        ar &dim1_d &dim2_d &dim3_d &dim4_d &dim2_times_dim3_times_dim4_d
            &dim3_times_dim4_d;
        ar &boost::serialization::base_object<std::vector<T>>(*this);
    }
    int dim1_d;
...
template <class T> class array_6d : public multiarray<T> {
  public:
    array_6d()
        : dim1_d(0), dim2_d(0), dim3_d(0), dim4_d(0), dim5_d(0), dim6_d(0),
          dim5xdim6_d(0), dim4xdim5xdim6_d(0), dim3xdim4xdim5xdim6_d(0),
          dim2xdim3xdim4xdim5xdim6_d(0), data(0) {}

    array_6d(const size_t d1, const size_t d2, const size_t d3, const size_t d4,
             const size_t d5, const size_t d6, T *pdata)
        : dim1_d(d1), dim2_d(d2), dim3_d(d3), dim4_d(d4), dim5_d(d5),
          dim6_d(d6), dim5xdim6_d(d5 * d6), dim4xdim5xdim6_d(d4 * d5 * d6),
          dim3xdim4xdim5xdim6_d(d3 * d4 * d5 * d6),
          dim2xdim3xdim4xdim5xdim6_d(d2 * d3 * d4 * d5 * d6), data(pdata){};
    ...
    T &operator()(const size_t i, const size_t j, const size_t k,
                  const size_t l, const size_t m, const size_t n) {
        assert((0 <= i) && (i < dim1_d));
        assert((0 <= j) && (j < dim2_d));
        assert((0 <= k) && (k < dim3_d));
        assert((0 <= l) && (l < dim4_d));
        assert((0 <= m) && (m < dim5_d));
        assert((0 <= n) && (n < dim6_d));
        size_t p = i * dim2xdim3xdim4xdim5xdim6_d + j * dim3xdim4xdim5xdim6_d +
                   k * dim4xdim5xdim6_d + l * dim5xdim6_d + m * dim6_d + n;
        return data[p]; // vector<T>::operator[](p);
    }

    T &operator()(const size_t i, const size_t j, const size_t k,
                  const size_t l, const size_t m, const size_t n) const {
        assert((0 <= i) && (i < dim1_d));
        assert((0 <= j) && (j < dim2_d));
        assert((0 <= k) && (k < dim3_d));
        assert((0 <= l) && (l < dim4_d));
    ...
    array_6d<T> &operator+=(const array_6d<T> &C) {
        assert(dim1() == C.dim1() && dim2() == C.dim2() && dim3() == C.dim3() &&
               dim4() == C.dim4() && dim5() == C.dim5() && dim6() == C.dim6());
    ...
    size_t get_size() {
        // if (mpigetrank() == 0)
        // cout << dim1_d<<" "<<dim2_d<<"  "<<dim3_d<<"  "<<dim4_d<<"
        // "<<dim5_d<<"  "<<dim6_d<<endl;
    ...
    void resize(const size_t i, const size_t j, const size_t k, const size_t l,
                const size_t m, const size_t n, T *pdata) {
        if (data != 0) {
            std::cout << "cannot resize a non-zero sized array." << std::endl;
            abort();
        }
        data = pdata;
        // data = (T*)(Stackmem[omprank].allocate(i*j*k*l*m*n*
        // (sizeof(T)/sizeof(double) + sizeof(T)%sizeof(double))));} data =
        // (T*)(SpinAdapted::Stackmem[omprank].allocate(i*j*k*l*m*n*
...
// (i,n)  (j,m)  and (k,l). We will only store terms where these three composite
// indices
...
template <class T> class array_8d : public vector<T>, public multiarray<T> {
  public:
    array_8d()
        : dim1_d(0), dim2_d(0), dim3_d(0), dim4_d(0), dim5_d(0), dim6_d(0),
          dim7_d(0), dim8_d(0), dim7xdim8_d(0), dim6xdim7xdim8_d(0),
          dim5xdim6xdim7xdim8_d(0), dim4xdim5xdim6xdim7xdim8_d(0),
          dim3xdim4xdim5xdim6xdim7xdim8_d(0),
          dim2xdim3xdim4xdim5xdim6xdim7xdim8_d(0), vector<T>() {}

    array_8d(const int d1, const int d2, const int d3, const int d4,
             const int d5, const int d6, const int d7, const int d8)
        : dim1_d(d1), dim2_d(d2), dim3_d(d3), dim4_d(d4), dim5_d(d5),
          dim6_d(d6), dim7_d(d7), dim8_d(d8), dim7xdim8_d(d7 * d8),
          ...
          dim2xdim3xdim4xdim5xdim6xdim7xdim8_d(d2 * d3 * d4 * d5 * d6 * d7 *
                                               d8),
    ...
    T &operator()(const int i, const int j, const int k, const int l,
        ...
        int u = i * dim2xdim3xdim4xdim5xdim6xdim7xdim8_d +
                ...
                k * dim4xdim5xdim6xdim7xdim8_d + l * dim5xdim6xdim7xdim8_d +
                m * dim6xdim7xdim8_d + n * dim7xdim8_d + p * dim8_d + q;
        return vector<T>::operator[](u);
    }

    T operator()(const int i, const int j, const int k, const int l,
                 const int m, const int n, const int p, const int q) const {
        assert((0 <= i) && (i < dim1_d));
        assert((0 <= j) && (j < dim2_d));
        assert((0 <= k) && (k < dim3_d));
        assert((0 <= l) && (l < dim4_d));
    ...
    int get_size() { return vector<T>::size(); }
    ...
    void resize(const int i, const int j, const int k, const int l, const int m,
    ...
    void serialize(Archive &ar, const unsigned int version) {
        ar &dim1_d &dim2_d &dim3_d &dim4_d &dim5_d &dim6_d &dim7_d &dim8_d
            &dim2xdim3xdim4xdim5xdim6xdim7xdim8_d
                &dim3xdim4xdim5xdim6xdim7xdim8_d &dim4xdim5xdim6xdim7xdim8_d
                    &dim5xdim6xdim7xdim8_d &dim6xdim7xdim8_d &dim7xdim8_d;
        ar &boost::serialization::base_object<std::vector<T>>(*this);
    }
    int dim1_d;
    int dim2_d;

...
class SweepParams {
  private:
    ...
    void serialize(Archive &ar, const unsigned int version) {
        ar &block_iter &sweep_iter &n_iters &forward_starting_size
            &backward_starting_size &keep_states &keep_states_ls;
        ar &keep_qstates &sys_add &env_add &noise &additional_noise
            &davidson_tol &lowest_energy &lowest_energy_spins &guesstype;
  ...
  public:
    ...
    const int &get_forward_starting_size() const {
        return forward_starting_size;
    }
    const int &get_backward_starting_size() const {
        return backward_starting_size;
    }
    ...
    const vector<double> &get_lowest_energy_spins() const {
        return lowest_energy_spins;
    }

...
int main(int argc, char *argv[]) {
    ...
    if (argc == 1 && mpigetrank() == 0) {
        ...
        pout << "This program comes with ABSOLUTELY NO WARRANTY; for details "
                "see license file."
             << endl;
        pout << "This is free software, and you are welcome to redistribute it"
             << endl;
        pout << "under certain conditions; see license file for details."
             << endl;
        return 0;
    }
    char *output = 0;

...
with BlockHamiltonian.get(fcidump='N2.STO3G.FCIDUMP', pg='d2h', su2=False) as hamil:
    ...
    for i in range(0, hamil.n_sites):
        rot_mats[tuple(range(0, 2 * i + 2))] = mps_info.get_left_rotation_matrix(i, mps[i])
